  ...
  return (
    <div className="subscribe1">
      <Container>
        <AnimationTitles
          title={`Contact us:`}
          className="title-popup-form text-center mx-auto w-75"
        />
        <p className="gray-50 text-center mt-3 mb-5"></p>
        <div className="contact-form d-flex justify-content-between align-items-center mx-auto p-1">
          ...
          >
            <input
              ...
              style={{ ...inputStyle }} // Add border style here
            />
            <input
              className="border-0 text-white ps-1 w-100"
              placeholder="Email Address *"
              name="Email"
              type="text"
              value={formData.Email}
              onChange={handleInputChange}
              style={{ ...inputStyle, border: "1px solid #27262e" }} // Add border style here
            />
            <input
              className="bg-transparent border-0 text-white ps-1 w-100"
              ...
              onChange={handleInputChange}
              style={{ ...inputStyle, border: "1px solid #27262e !important" }} // Add border style here
            />
            <input
              className="bg-transparent border-0 text-white ps-1 w-100"
              ...
              style={{
                ...inputStyle,
                border: "1px solid #27262e", // Add border style here
                marginBottom: "1rem",
              }}
            />
